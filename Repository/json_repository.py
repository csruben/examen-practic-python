...
class JsonRepository(Repository):
    ...
    def create(self, entity: Entity) -> None:
        """
        Creeaza o nota sau o sesiune
        :param entity: nota/sesiune
        :return: nota/sesiune
        """
    ...
    def read(self, id_entity: object = None) \
        ...
        """
        Citeste nota/sesiunea introdusa sau returneaza o listat cu note/sesiuni daca nu este introdus un id
        :param id_entity: id nota/sesiune
        :return: nota/sesiune
        """
        entities = self.__read_file()
        if id_entity:
